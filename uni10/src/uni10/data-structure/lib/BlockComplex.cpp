...
*  @endlicense
*  @brief Implementation file of Block class: complex member functions
...
namespace uni10{
  ...
  Block::Block(cflag tp, size_t _Rnum, size_t _Cnum, bool _diag): r_flag(RNULL), c_flag(tp), m_elem(NULL), cm_elem(NULL), Rnum(_Rnum), Cnum(_Cnum), diag(_diag), ongpu(ONGPU){}

  Block::Block(cflag tp, size_t _Rnum, size_t _Cnum, bool _diag, bool _ongpu): r_flag(RNULL), c_flag(tp), m_elem(NULL), cm_elem(NULL), Rnum(_Rnum), Cnum(_Cnum), diag(_diag), ongpu(_ongpu){}
