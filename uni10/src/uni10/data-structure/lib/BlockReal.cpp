...
*  @endlicense
*  @brief Implementation file of Block class: real member functions
*  @author Yun-Da Hsieh
*  @date 2014-05-06
*  @since 0.1.0
*
...
namespace uni10{
  ...
  Block::Block(rflag _tp, size_t _Rnum, size_t _Cnum, bool _diag): r_flag(_tp), c_flag(CNULL), m_elem(NULL), cm_elem(NULL), Rnum(_Rnum), Cnum(_Cnum), diag(_diag), ongpu(ONGPU){}

  Block::Block(rflag _tp, size_t _Rnum, size_t _Cnum, bool _diag, bool _ongpu): r_flag(_tp), c_flag(CNULL), m_elem(NULL), cm_elem(NULL), Rnum(_Rnum), Cnum(_Cnum), diag(_diag), ongpu(_ongpu){}
