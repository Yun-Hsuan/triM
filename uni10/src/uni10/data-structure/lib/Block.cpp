...
namespace uni10{
  ...
  // Default Real
  Block::Block():r_flag(RTYPE), c_flag(CNULL), m_elem(NULL), cm_elem(NULL), Rnum(0), Cnum(0), diag(false), ongpu(ONGPU){}

  Block::Block(size_t _Rnum, size_t _Cnum, bool _diag): r_flag(RTYPE), c_flag(CNULL), m_elem(NULL), cm_elem(NULL), Rnum(_Rnum), Cnum(_Cnum), diag(_diag), ongpu(ONGPU){}

  Block::Block(size_t _Rnum, size_t _Cnum, bool _diag, bool _ongpu): r_flag(RTYPE), c_flag(CNULL), m_elem(NULL), cm_elem(NULL), Rnum(_Rnum), Cnum(_Cnum), diag(_diag), ongpu(_ongpu){}
