...
/// @see \ref Matrix, UniTensor
	...
	public:
        ...
        Block(size_t _Rnum, size_t _Cnum, bool _diag, bool _ongpu);
	    ...
	    Block(rflag _tp, size_t _Rnum, size_t _Cnum, bool _diag, bool _ongpu);
        ...
        Block(cflag _tp, size_t _Rnum, size_t _Cnum, bool _diag, bool _ongpu);
